...
def renderizar_ui():
    st.markdown("<div class='calc-info'><b>O que avalia:</b> Audita a qualidade da coleta de dados pós-operatórios em <b>fraturas do úmero proximal</b>. Baseado nas diretrizes da força-tarefa da <i>American Shoulder and Elbow Surgeons (ASES)</i> para padronização de desfechos clínicos.</div>", unsafe_allow_html=True)
    ...
    if st.button("Auditar Protocolo de Desfechos", key="btn_proximal_humerus"):
        ...
        salvar_registro("Auditoria Seguimento Úmero P.", res, "melhora", params_str) 
